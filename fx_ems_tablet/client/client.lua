...
function startAnim()
	CreateThread(function()
	  ...
	  while not HasAnimDictLoaded("amb@world_human_seat_wall_tablet@female@base") do
		...
		attachObject()
		TaskPlayAnim(Citizen.InvokeNative(0x43A66C31C68491C0, -1), "amb@world_human_seat_wall_tablet@female@base", "base" ,8.0, -8.0, -1, 50, 0, false, false, false)
	end)
end
function attachObject()
	tab = Citizen.InvokeNative(0x509D5878EB39E842, GetHashKey("prop_cs_tablet"), 0, 0, 0, true, true, true)
	AttachEntityToEntity(tab, Citizen.InvokeNative(0x43A66C31C68491C0, -1), GetPedBoneIndex(Citizen.InvokeNative(0x43A66C31C68491C0, -1), 57005), 0.17, 0.10, -0.13, 20.0, 180.0, 180.0, true, true, false, true, 1, true)
end
function stopAnim()
	StopAnimTask(Citizen.InvokeNative(0x43A66C31C68491C0, -1), "amb@world_human_seat_wall_tablet@female@base", "base" ,8.0, -8.0, -1, 50, 0, false, false, false)
	DeleteEntity(tab)
end
...
function loadDefaultData()
	ESX.TriggerServerCallback('emstablet:getDefaultData', function(result)
		SendNUIMessage({
			...
			emsonline = tostring(exports['esx_scoreboard']:getPeople('ambulance')),
